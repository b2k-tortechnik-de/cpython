...
PyFloat_FromDouble(double fval)
{
    ...
    PyFloatObject *op = (PyFloatObject *)_PyFreeList_Alloc(&interp->float_freelist);
#else
...
_PyFloat_ExactDealloc(PyObject *obj)
{
    ...
    PyInterpreterState *interp = _PyInterpreterState_GET();
    _PyFreeList_Free(&interp->float_freelist, op);
...
{
#if WITH_FREELISTS
    _PyFreeList_Clear(&interp->float_freelist);
#endif
}
