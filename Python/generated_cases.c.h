...
// Do not edit!
        ...
        TARGET(LOAD_CLOSURE) {
            ...
            Py_INCREF(value);
            #line 67 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_FAST_CHECK) {
            ...
            if (value == NULL) goto unbound_local_error;
            Py_INCREF(value);
            #line 79 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST) {
            ...
            assert(value != NULL);
            Py_INCREF(value);
            #line 92 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST_AND_CLEAR) {
            ...
            GETLOCAL(oparg) = NULL;
            #line 104 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST_LOAD_FAST) {
            ...
            Py_INCREF(value1);
            Py_INCREF(value2);
            #line 122 "Python/generated_cases.c.h"
            STACK_GROW(2);
        ...
        TARGET(STORE_FAST) {
            ...
            #line 144 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(STORE_FAST_LOAD_FAST) {
            ...
            value2 = GETLOCAL(oparg2);
            Py_INCREF(value2);
            #line 158 "Python/generated_cases.c.h"
            stack_pointer[-1] = value2;
            DISPATCH();
        }
        ...
        TARGET(POP_TOP) {
            ...
            #line 179 "Python/generated_cases.c.h"
            Py_DECREF(value);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_TUPLE_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(tuple);
            #line 701 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(RAISE_VARARGS) {
            ...
            #line 935 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1050 "Python/generated_cases.c.h"
                Py_DECREF(obj);
        ...
        TARGET(STORE_GLOBAL) {
            ...
            if (err) goto pop_1_error;
            #line 1617 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
